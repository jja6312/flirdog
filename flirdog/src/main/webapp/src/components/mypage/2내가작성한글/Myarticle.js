...
const Myarticle = () => {
    return (
        <div>
            ...
            <ul className='row m-0 p-0'>    
                <li className='col-lg-3 d-flex justify-content-center'></li>
                <li className='col-lg-2 d-flex justify-content-center'><Link to="/mypage/Myarticle" className={Mypage.Link}><span className={Mypage.LiVisible}>Q&A</span> </Link></li>
                <li className='col-lg-2 d-flex justify-content-center'><Link to="/mypage/MyarticleRounge" className={Mypage.Link}><span className={Mypage.LiVisible}>라운지</span></Link></li>
                <li className='col-lg-2 d-flex justify-content-center'><Link to="/mypage/MyarticleRepl" className={Mypage.Link}><span className={Mypage.LiVisible}>댓글</span></Link></li>
                <li className='col-lg-2 d-flex justify-content-center'></li>
            </ul>
            ...
            <Container className='px-10 mt-7'> 
                <Row className={`${Mypage.Myarticle1}`}>
                    <Col xs={5} md={4}>
                    </Col>
                ...
                <div className='row'>
                    <div className='col-xs-4 col-md-4 d-flex justify-content-center'></div>
                    <div className='col-xs-4 col-md-4 d-flex justify-content-center'>
                        <div className={Mypage.Myarticle2}>
                            <h4>등록한 질문이 없습니다.</h4>
                        </div>
                    </div>
                    <div className='col-xs-4 col-md-4 d-flex justify-content-center'></div>
