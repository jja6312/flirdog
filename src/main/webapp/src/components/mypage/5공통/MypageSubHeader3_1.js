...
const MypageSubHeader3_1 = () => {
    ...
    const [changeColor3_1 , setChangeColor3_1] = useState(false);

    useEffect(() => {   
        setChangeColor3(true);
        setChangeColor3_1(true);
        sub3();
    },[])
                ...
                <div>
                    <Container className='px-10'>{/* 마이페이지헤더 하단부분 */}
                        <ul className='row m-0 p-0'>    
                            ...
                            <li className='col-lg-2 col-md-2 col-sm-3 d-flex justify-content-center'><Link to="/mypage/MypointRecharge" className={Mypage.Link}><span className={` Mypage.LiVisible ${changeColor3_1 ? Mypage.borderbottomPink : Mypage.borderbottomPinkOff}`}>포인트 충전</span> </Link></li>
...
export default MypageSubHeader3_1;