...
const MypageSubHeader2_3 = () => {
    ...
    const [changeColor2_3 , setChangeColor2_3] = useState(false);

    useEffect(() => {   
        setChangeColor2(true);
        setChangeColor2_3(true);
        sub2();
    },[])
                ...
                <div>
                    <Container className='px-10'>{/* 마이페이지헤더 하단부분 */}
                        ...
                        <ul className='row m-0 p-0'>    
                            ...
                            <li className='col-lg-2 col-md-2 col-md-2 col-sm-2 d-flex justify-content-center'><Link to="/mypage/MyarticleRepl" className={Mypage.Link}><span className={` Mypage.LiVisible ${changeColor2_3 ? Mypage.borderbottomPink : Mypage.borderbottomPinkOff}`}>댓글</span></Link></li>
...
export default MypageSubHeader2_3;