...
const DateWrite = () => {
  ...
  const { dogName, dogAge, dogGender, dogsBreed, dogMBTI, isNeutralized } =
    dogsDTO;
  ...
  const onInput = (e) => {
    ...
    setMatchingDTO({ ...matchingDTO, [name]: value });
                  ...
                  <div className={TableCss.FormTitleDiv}>
                    ...
                    <Dropdown>
                      ...
                      >
                        <Dropdown.Item
                          href="#/action-1"
                          onClick={() => handlePurposeSelect("연 애")}
                        ...
                        <Dropdown.Item
                          href="#/action-2"
                          onClick={() => handlePurposeSelect("산 책")}
                          name="matchingPurpose"
                          value={purposeSelect || ""}
                          onChange={onInput}
                        >
