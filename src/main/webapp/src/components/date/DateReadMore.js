          ...
          <div className={ReadMoreCSS.formTableDiv}>
            <div style={{}}>
              <div className={ReadMoreCSS.ReadMoreHeader}>
                ...
                >
                  <span style={{ fontWeight: "bold" }}>
                    작성일 : {createdAtDate}&nbsp;&nbsp;&nbsp;{createdAtTime}
                  </span>
                </div>
                <div
                  style={{
            ...
            >
              <div style={{ width: "70%" }}>
                <div
                  className={ReadMoreCSS.CarouselDiv}
                  style={{
                    width: "100%",
                    display: "flex",
                    justifyContent: "center",
              ...
              <div style={{ width: "30%", marginRight: "5%", padding: "2%" }}>
                <div
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={ReadMoreCSS.matchingState}
                      style={{
                        backgroundColor:
                    ...
                    >
                      <div>{matchingDTO.matchingState}</div>
                    </div>
                        ...
                        {[1, 2, 3, 4, 5].map((starIndex) => {
                          ...
                          return (
                            <img
                              ...
                              alt="별"
                              style={{
                                marginRight: starIndex === 5 ? "0" : "10px",
                              }}
                            />
                          );
                        })}
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      {matchingDTO.dogGender === "Male" ? "남 아" : "여 아"}
                    </div>
                  </div>
                  <div style={{ width: "50px" }}></div>
                  <div>
            ...
            >
              <Button
                ...
                style={{
                  ...
                  height: "70px",
                  boxShadow:
                    "0 0 10px rgba(0, 0, 0, 0.6)" /* 그림자 효과 설정 */,
                }}
