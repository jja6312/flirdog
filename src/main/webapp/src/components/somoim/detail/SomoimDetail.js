...
const SomoimDetail = () => {
    ...
    return (
        ...
        <Container  className='px-10 py-3' style={{border: '1px solid blue', display: 'flex', flexDirection: 'column', background: '#FFF4F4' }}> 
            <div className='row'>
                <div className='col-lg-3 col-12 d-flex justify-content-left' style={{ justifyContent:'center', textAlign: 'left', alignItems: 'center', border: '1px solid pink' }}>
                    <img className="responsive-image" style={{ width: '90%', borderRadius: '5px', objectFit: 'cover' }} src="https://via.placeholder.com/460x290" alt="somoim-image1" />
                </div>
                <div className={`col-lg-9 col-12 d-flex justify-content-center ${styles.moimMainTitle}`} style={{border: '1px solid black'}}>
                    <div className="container">
                        ...
                        <div className="content d-flex">
                            <div className="flex-row col-lg-3 d-none d-md-block">
                                <p className='info'>
                                    신청마감
                                </p>
                            </div>
                            <div className="flex-row col-lg-9">
                                <p className='detail'>
                                    서울 강서구 강서로 정조길 940-11 (영화동) 연세IT미래교육원 빌딩
                                </p>
                                    {/* <div className="buttons">
                                        <div className="join-button">
                                        <div className="join-gradient"></div>
                                        <p>가입하기</p>
                                        </div>
                                    </div> */}
                                </div>
            ...
            <div style={{height: '370px', position: 'relative' }}>
                <div className="Rectangle57" style={{ width: '1220px', height: '370px', left: '0px', top: '0px', position: 'absolute', background: '#FFF4F4' }}></div>
                <img className="Adfdsafdsaf1" style={{ width: '400px', height: '289.82px', left: '33px', top: '20.97px', position: 'absolute', borderRadius: '5px' }} src="https://via.placeholder.com/460x290" alt="somoim-image1" />
                ...
                <div style={{ width: '1014px', height: '241px', left: '476px', top: '111px', position: 'absolute' }}>
                    <div className="20231116135994011It140018000212345678SulmukjaNaverCom" style={{ width: '855px', height: '228px', left: '124px', top: '-30px', position: 'absolute', color: 'black', fontSize: '20px', fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>
                        ~ 2023-11-16(목) 13:59
                        <br />
                    ...
                    <div style={{ width: '132px', height: '241px', left: '-43px', top: '-27px', position: 'absolute', textAlign: 'right', color: '#F56084', fontSize: '20px', fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>
                        신청마감<br />모임장소<br />모임일자<br />대상자<br /><br />개설자 정보<br /><br /><br /><br />
                    </div>
                </div>
                <div style={{ width: '1038px', height: '72px', left: '465px', top: '22px', position: 'absolute' }}>
                    <span style={{ color: 'black', fontSize: '30px', fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word' }}>어서오개 한잔하개</span>
                    <span style={{ color: 'black', fontSize: '22px', fontFamily: 'Inter', fontWeight: '100', wordWrap: 'break-word' }}>강아지와 술을 사랑하는 모임</span>
                    <span style={{ color: 'black', fontSize: '22px', fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word' }}><br /></span>
                </div>
                <div className="Line12" style={{ width: '585px', height: '0px', left: '600px', top: '220px', position: 'absolute', border: '1px black solid' }}></div>
                <div className="Line13" style={{ width: '119px', height: '0px', left: '453px', top: '220px', position: 'absolute', border: '1px #F56084 solid' }}></div>
                <div style={{ width: '110px', height: '23px', left: '1090px', top: '143px', position: 'absolute' }}>
                ...
                <div style={{ width: '300px', height: '60px', left: '960px', top: '288px', position: 'absolute' }}>
                    <div className="Rectangle59" style={{ width: '238px', height: '42px', left: '0px', top: '0px', position: 'absolute', background: 'linear-gradient(180deg, #FB4B4B 0%, rgba(255, 208.25, 219.55, 0.66) 63%, rgba(255, 208.25, 219.55, 0.62) 80%, rgba(255, 208.25, 219.55, 0) 100%)', boxShadow: '0px 4px 4px rgba(217.10, 189.97, 189.97, 0.25)' }}></div>
                    <div style={{ width: '277px', height: '58px', left: '-16px', top: '0px', position: 'absolute', textAlign: 'center', color: 'white', fontSize: '27px', fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>가입하기</div>
                </div>
            </div>
        ...
        <Container  className='px-10 py-3' style={{border: '1px solid blue', display: 'flex', flexDirection: 'column' }}>
            <div className='row'>
                ...
                <div className='col-lg-3 col-12 d-flex justify-content-right' style={{ textAlign: 'center', alignSelf: 'flex-end', border: '1px solid brown', padding: 0 }}>
                    ...
                    <div style={{ width: '290px', height: '1307px', position: 'relative', paddingRight: '90%' }}>
                        <div className="Rectangle56" style={{ width: '322px', height: '1253.79px', left: '0px', top: '52.21px', position: 'absolute', background: '#FFF4F4' }}></div>
                        <div style={{ width: '288px', height: '1209px', left: '17px', top: '78px', position: 'absolute', background: 'white' }}></div>
                        <div style={{ width: '287px', height: '90px', left: '18px', top: '1217px', position: 'absolute' }}>
                        ...
                        <div className="1" style={{ width: '385px', height: '154px', left: '16px', top: '105px', position: 'absolute' }}>
                            ...
                            <div className="2" style={{ width: '88px', height: '75px', left: '14px', top: '17px', position: 'absolute', color: '#454141', fontSize: '15px', fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word' }}>다음주에 저희 일요일날 가는 걸로 아는데 혹시 2차도 예정있나요?</div>
                            </div>
                        ...
                        <div className="2" style={{ width: '385px', height: '153px', left: '4px', top: '273px', position: 'absolute' }}>
                        ...
                        <div className="3" style={{ width: '385px', height: '164px', left: '67px', top: '463px', position: 'absolute' }}>
                        <div style={{ width: '215px', height: '82px', left: '0px', top: '0px', position: 'absolute' }}>
                            <div className="Rectangle60" style={{ width: '215px', height: '82px', left: '0px', top: '0px', position: 'absolute', background: '#F68E8E', borderTopLeftRadius: '40px', borderTopRightRadius: '40px', borderBottomRightRadius: '40px' }}></div>
                        ...
                        <div className="4" style={{ width: '385px', height: '153px', left: '4px', top: '622px', position: 'absolute' }}>
                        <div style={{ width: '215px', height: '82px', left: '64px', top: '0px', position: 'absolute' }}>
                            <div className="Rectangle60" style={{ width: '215px', height: '82px', left: '0px', top: '0px', position: 'absolute', background: '#FFF4F4', borderTopLeftRadius: '40px', borderTopRightRadius: '40px', borderBottomRightRadius: '40px' }}></div>
                        ...
                        <div className="5" style={{ width: '385px', height: '153px', left: '11px', top: '789px', position: 'absolute' }}>
                        <div style={{ width: '215px', height: '82px', left: '64px', top: '0px', position: 'absolute' }}>
                            <div className="Rectangle60" style={{ width: '215px', height: '82px', left: '0px', top: '0px', position: 'absolute', background: '#FFF4F4', borderTopLeftRadius: '40px', borderTopRightRadius: '40px', borderBottomRightRadius: '40px' }}></div>
                        ...
                        <div className="6" style={{ width: '385px', height: '164px', left: '84px', top: '972px', position: 'absolute' }}>
                        <div style={{ width: '215px', height: '82px', left: '0px', top: '0px', position: 'absolute' }}>
                            <div className="Rectangle60" style={{ width: '215px', height: '82px', left: '0px', top: '0px', position: 'absolute', background: '#F68E8E', borderTopLeftRadius: '40px', borderTopRightRadius: '40px', borderBottomRightRadius: '40px' }}></div>
                            <div style={{ width: '187px', height: '75px', left: '14px', top: '17px', position: 'absolute', color: '#454141', fontSize: '15px', fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word' }}>저도 이번 모임 기대하고 있습니다ㅋㅋㅋ 아끼던 양주 가져갑니다</div>
                        </div>
                        <div style={{ width: '80px', height: '58px', left: '158px', top: '82px', position: 'absolute' }}>
                            <img className="UserMale" style={{ width: '45px', height: '45px', left: '14px', top: '0px', position: 'absolute' }} src="https://via.placeholder.com/45x45" alt="UserMale" />
                            <div style={{ width: '80px', height: '14px', left: '0px', top: '44px', position: 'absolute', textAlign: 'center', color: 'black', fontSize: '16px', fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word' }}>나</div>
                        </div>
                        </div>
