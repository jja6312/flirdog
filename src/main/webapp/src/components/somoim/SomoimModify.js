...
const SomoimModify = ({somoimId}) => {
    ...
    //   }, [location.pathname]);
      ...
      const { somoimName, introduceSub, introduceDetail, address, address2, zipcode, 
        memberCount, target, accountName, accountEmail, accountPhone, introducePhoto, introducePhotoUUID } = formData
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        ...
        if (form.checkValidity() === false) {
          ...
          try {
            const confirmed = window.confirm("정말 소모임을 수정하시겠습니까?");
            ...
            if (confirmed) {
              ...
              const response = await axios
                ...
                .then(
                  alert("소모임수정이 완료되었습니다."),
                  navigate("/somoim")
                )
                .catch((error) => console.log(error));
              console.log("서버 응답 오류:", response);
            } else {
              console.log("소모임 수정이 취소되었습니다.");
            } //if
          } catch (e) {
    ...
    return (
        <div>
            ...
            >
                ...
                {/* <div className='col-13 col-md-4' style={{ textAlign: 'left', alignSelf: 'flex-end' }}>소모임 수정입니다.</div> */}
                <div
